...
A dokumentum a [Lyx](https://www.lyx.org/)  2.1.4-es verziójával lett szerkeztve. A `master.lyx` file tartalmazza a dokumentum gyökerét.  A Fig konyvtárban vannak a képek.
